...
export const galatasarayPlayers = [
  ...
  { id: 'gs-arda-unyay', name: 'Arda Ünyay', teamId: 'galatasaray', trainingStatus: TRAINING_STATUS.ASSOC, position: POSITIONS.CB, nationality: 'Turkish', age: 18, hasBlueCard: false },
  { id: 'gs-ismail-jakobs', name: 'Ismail Jakobs', teamId: 'galatasaray', trainingStatus: TRAINING_STATUS.NONE, position: POSITIONS.LB, nationality: 'Senegalese', age: 26, hasBlueCard: false },
  ...
  { id: 'gs-eren-aydin', name: 'Eren Aydın', teamId: 'galatasaray', trainingStatus: TRAINING_STATUS.CLUB, position: POSITIONS.ST, nationality: 'Turkish', age: 22, hasBlueCard: false },
  ...
  { id: 'gs-icardi', name: 'Mauro Icardi', teamId: 'galatasaray', trainingStatus: TRAINING_STATUS.NONE, position: POSITIONS.ST, nationality: 'Argentinian', age: 32, hasBlueCard: false },
];
