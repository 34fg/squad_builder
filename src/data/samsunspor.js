...
export const samsunsporPlayers = [
  ...
  { id: 'sam-yunus-emre-cift', name: 'Yunus Emre Çift', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.CLUB, position: POSITIONS.LB, nationality: 'Turkish', age: 21, hasBlueCard: false },
  { id: 'sam-bedirhan-cetin', name: 'Bedirhan Çetin', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.CLUB, position: POSITIONS.CB, nationality: 'Turkish', age: 19, hasBlueCard: false },
  { id: 'sam-logi-tomasson', name: 'Logi Tómasson', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.NONE, position: POSITIONS.LB, nationality: 'Icelandic', age: 24, hasBlueCard: false },
  { id: 'sam-soner-gonul', name: 'Soner Gönül', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.CLUB, position: POSITIONS.RB, nationality: 'Turkish', age: 28, hasBlueCard: false },
  ...
  { id: 'sam-muhammet-ozbaskici', name: 'Muhammet Özbaskıcı', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.CLUB, position: POSITIONS.CM, nationality: 'Turkish', age: 19, hasBlueCard: false },
  { id: 'sam-soner-aydogdu', name: 'Soner Aydoğdu', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.CLUB, position: POSITIONS.CM, nationality: 'Turkish', age: 34, hasBlueCard: false },
  { id: 'sam-alper-efe-pazar', name: 'Alper Efe Pazar', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.CLUB, position: POSITIONS.CM, nationality: 'Turkish', age: 20, hasBlueCard: false },
  { id: 'sam-afonso-sousa', name: 'Afonso Sousa', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.NONE, position: POSITIONS.CAM, nationality: 'Portuguese', age: 25, hasBlueCard: false },
  { id: 'sam-carlo-holse', name: 'Carlo Holse', teamId: 'samsunspor', trainingStatus: TRAINING_STATUS.NONE, position: POSITIONS.LW, nationality: 'Danish', age: 26, hasBlueCard: false },
